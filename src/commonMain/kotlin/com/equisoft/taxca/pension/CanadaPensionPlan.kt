...
val Cpp: PublicPensionPlan = PublicPensionPlan(
    ...
    flatBenefit = FlatBenefit(
        ...
        under45 = 9642.48,
        under45WithChild = 9642.48,
        under45Disabled = 9642.48,
        from45To64 = 9642.48,
        over64WithoutPension = 10855.08,
    ),
    indexationRateReferences = listOf( // Previous year inflation used as indexation
        2007 to 0.020,
        2008 to 0.022,
        2009 to 0.023,
        2010 to 0.003,
    ...
    maxPension = MaxPension(
        ...
        combinedRetirementSurvivor = 18378.72,
        deathBenefit = 2500.0,
    ),
    maxRequestAge = 70,
    minRequestAge = 60,
